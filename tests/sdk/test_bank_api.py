...
body = obp_python.EmptyClassJson(
    ""
)  # EmptyClassJson | EmptyClassJson object that needs to be added.
api_version = "v5.0.0"  # str | eg:v2.2.0, v3.0.0
# bank_id = 'obp1' # str | The bank id
bank_id = "Mobilink"  # str | The bank id


def test_transaction_types():
    api_response = api_instance.o_bpv2_0_0_get_transaction_types(body, bank_id).to_dict()
